...
<gameSystem name="Spectre Operations V3" id="sys-c514-e280-17d7-17af" battleScribeVersion="2.03" revision="2" type="gameSystem" xmlns="http://www.battlescribe.net/schema/gameSystemSchema">
  <categoryEntries>
  ...
  <sharedProfiles>
    <profile name="Civil" id="d2df-5d35-cf20-9324" hidden="false" selectable="true" selectionGroup="No Entrenado" typeId="9e34-ec9a-2063-cc02" typeName="Combatiente">
      <characteristics>
    ...
    <profile name="Criminal" id="3c83-9cde-8e46-659d" hidden="false" selectable="true" selectionGroup="No Entrenado" typeId="9e34-ec9a-2063-cc02" typeName="Combatiente">
      <characteristics>
        <characteristic name="Movimiento" typeId="62b0-2d44-1adc-2daf">4</characteristic>
    ...
    <profile name="Recluta" id="aac1-39ef-dfed-abde" hidden="false" selectable="true" selectionGroup="No Entrenado" typeId="9e34-ec9a-2063-cc02" typeName="Combatiente">
      <characteristics>
        <characteristic name="Movimiento" typeId="62b0-2d44-1adc-2daf">4</characteristic>
        <characteristic name="Balística" typeId="e9bf-d1ec-4f7e-b6fb">8</characteristic>
        <characteristic name="Percepción" typeId="319e-be1e-4f04-0f03">10</characteristic>
    ...
    <profile name="Milicia" id="309c-9800-d8c1-1acd" hidden="false" selectable="true" selectionGroup="No Entrenado" typeId="9e34-ec9a-2063-cc02" typeName="Combatiente">
      <characteristics>
    ...
    <profile name="Militares" id="9139-4807-47ea-d8b2" hidden="false" selectable="true" selectionGroup="Entrenado" typeId="9e34-ec9a-2063-cc02" typeName="Combatiente">
      <characteristics>
        <characteristic name="Movimiento" typeId="62b0-2d44-1adc-2daf">5</characteristic>
    ...
    <profile name="Veterano" id="c8a0-8900-9535-b743" hidden="false" selectable="true" selectionGroup="Entrenado" typeId="9e34-ec9a-2063-cc02" typeName="Combatiente">
      <characteristics>
        <characteristic name="Movimiento" typeId="62b0-2d44-1adc-2daf">5</characteristic>
    ...
    <profile name="Perro No Entrenado" id="624d-8df3-4389-1edf" hidden="false" typeId="9e34-ec9a-2063-cc02" typeName="Combatiente">
      <characteristics>
    ...
    <profile name="Perro Entrenado" id="9046-535d-f3ea-c264" hidden="false" typeId="9e34-ec9a-2063-cc02" typeName="Combatiente">
      <characteristics>
        <characteristic name="Movimiento" typeId="62b0-2d44-1adc-2daf">7</characteristic>
        <characteristic name="Balística" typeId="e9bf-d1ec-4f7e-b6fb">0</characteristic>
    ...
    <profile name="M-UAV" id="b3b5-e35b-d485-f2b6" hidden="false" typeId="9e34-ec9a-2063-cc02" typeName="Combatiente">
      <characteristics>
    ...
    <profile name="M-UGV" id="5acd-f4d1-c5f7-6d23" hidden="false" typeId="9e34-ec9a-2063-cc02" typeName="Combatiente">
      <characteristics>
        <characteristic name="Movimiento" typeId="62b0-2d44-1adc-2daf">7</characteristic>
        <characteristic name="Balística" typeId="e9bf-d1ec-4f7e-b6fb">6</characteristic>
...
► Además, si se fallan las Pruebas de Estrés en un Combate que involucra un arma incendiaria, la Unidad Objetivo será automáticamente pineada.</description>
    ...
    <rule name="Humo" id="c141-ef00-f851-08b9" hidden="false">
      <description>Se aplican las siguientes reglas durante el resto del turno:
- La unidad afectada obtiene un bonificador de +4 a las Pruebas de Percepción. Este bonificador solo está activo mientras la Unidad esté dentro o totalmente oculto por el humo.
- La Unidad afectada no puede realizar acciones de combate.
Una Unidad amiga puede ser objetivo de armas con la regla de humo.</description>
    </rule>
    <rule name="Humo Infrarrojo" id="ebd5-c5f3-704c-08d5" hidden="false">
      <description>-Bloquea Visión Térmica.
Se aplican las siguientes reglas durante el resto del turno:
- La unidad afectada obtiene un bonificador de +4 a las Pruebas de Percepción. Este bonificador solo está activo mientras la Unidad esté dentro o totalmente oculto por el humo.
- La Unidad afectada no puede realizar acciones de combate.
Una Unidad amiga puede ser objetivo de armas con la regla de humo.</description>
    </rule>
    ...
    <rule name="Gas Lacrimógeno" id="8b11-e96c-7a85-1952" hidden="false">
      <description>-Unidades dentro del  AoE ganan +1 se Estrés
Algunos equipos, como los Respiradores, negarán estos efectos.
Se aplican las siguientes reglas durante el resto del turno:
- La unidad afectada obtiene un bonificador de +4 a las Pruebas de Percepción. Este bonificador solo está activo mientras la Unidad esté dentro o totalmente oculto por el humo.
- La Unidad afectada no puede realizar acciones de combate.
Una Unidad amiga puede ser objetivo de armas con la regla de humo.</description>
...
► Los proyectiles merodeadores tienen el mismo perfil para los rangos de CQB, Combate y Extremo, que se usa para realizar la Acción de Combate. Para  realizar el Combate, usa la Balística de la Unidad que está realizando la Acción de Combate como de costumbre.</description>
    ...
    <rule name="Vehículos con Orugas" id="5584-88f3-f33a-1cce" hidden="false">
...
Para efectos de armas de área de efecto (AoE), trata al vehículo y a la unidad transportada como una sola unidad.</description>
    ...
    <rule name="Sistema de Armas Remotas (RWS)" id="903c-ad3b-d4d7-b130" hidden="false">
      <description>Los SWR no tendrán ningún modificador para acertar cuando se aplique momentum adicional a un combate utilizando el arma. El arma también obtendrá los beneficios de las NVG Híbridas Térmicas MK3 (página 58) para representar sus ópticas avanzadas y sistemas de puntería. Una Acción de Combate tampoco sufrirá una penalización por realizar un movimiento antes del combate, debido a la estabilización del arma y el ordenador de asistencia balística.</description>
    </rule>
    <rule name="RWS Ligero" id="2b72-da01-24b0-bf6a" hidden="false">
      <description>Se puede montar una única Ametralladora Ligera o Mediana en el Sistema.</description>
    </rule>
    <rule name="RWS Medio" id="c113-744f-f867-039d" hidden="false">
      <description>Un RWS Mediano puede montar una única Ametralladora (Ligera, Mediana o Pesada), Lanzagranadas Automático, Minigun, Lanzador Antitanque o Cañón de 30 mm. El SWR también puede estar equipado con Dispensadores de Humo.</description>
    </rule>
    <rule name="RWS Pesado" id="7d50-3210-c106-014f" hidden="false">
      <description>Los SWR no tendrán ningún modificador para acertar cuando se aplique momentum adicional a un combate utilizando el arma. El arma también obtendrá los beneficios de las NVG Híbridas Térmicas MK3 (página 58) para representar sus ópticas avanzadas y sistemas de puntería. Una Acción de Combate tampoco sufrirá una penalización por realizar un movimiento antes del combate, debido a la estabilización del arma y el ordenador de asistencia balística.</description>
    </rule>
    <rule name="Arma en Afuste Exterior" id="aa64-1ad5-bb39-6d17" hidden="false">
      <description>Si se utiliza un arma montada en afuste en un combate, el blindaje del vehículo se reducirá en -1 por el resto del turno</description>
    </rule>
    <rule name="Blindaje Reactivo" id="a787-2ff0-7eb3-1de3" hidden="false">
      <description>El ERA aumentará la Clase del Vehículo en 1 contra todas las armas con las reglas de Antiblindaje o Antitanque.
Si se utiliza una de estas armas en un combate con un Vehículo con ERA, las unidades de infantería a de 3” del Vehículo sufrirán un impacto de AoE 3, con una Letalidad de 6.</description>
    </rule>
    <rule name="Blindaje Reactivo Avanzado" id="9158-c49c-4f94-d3a4" hidden="false">
      <description>El ERA aumentará la Clase del Vehículo en 1 contra todas las armas con las reglas de Antiblindaje, Antitanque y Penetradoras Cinéticas. Las armas con la regla Tándem y Penetrador Cinético no obtendrán beneficios de sus reglas especiales contra un vehículo con ERA avanzado.
Si se utiliza una de estas armas en un combate con un Vehículo con ERA, las unidades de infantería a de 3” del Vehículo sufrirán un impacto de AoE 3, con una Letalidad de 6.</description>
    </rule>
    <rule name="APS 1ª Generación" id="49bc-064e-6883-04dd" hidden="false">
      <description>Si un vehículo con un APS es la Unidad Objetivo en un Combate con un arma con la Regla de Penetración de Blindaje, Antiblindaje o Antitanque y es impactado, al realizar una Prueba de Percepción, el valor de Percepción del vehículo se incrementa a 6. Las Armas Guiadas tampoco obtienen beneficios de la Regla Guiado</description>
    </rule>
    <rule name="APS Nueva Generación" id="e0a8-f237-5f95-44d6" hidden="false">
...
El Valor de Percepción del Vehículo al realizar pruebas de Percepción se incrementa a 5. Los APS avanzados también utilizan estas reglas cuando son el Objetivo de un Arma con el Penetrador Cinético. Las reglas especiales de Ataque desde Arriba también se ignoran cuando se usan contra un Vehículo con APS avanzado.</description>
    ...
    <rule name="Descargadores de Humo" id="ee62-7128-d156-4062" hidden="false">
      <description>Si un Vehículo con Lanzadores de Humo está siendo impactado, al realizar una Prueba de Percepción, el Vehículo obtiene +2 a su Percepción durante 2 turnos.</description>
    </rule>
    <rule name="Protección contra Minas" id="a069-d66f-45c4-5c57" hidden="false">
    ...
    <rule name="Inhibidor de Explosivos" id="55ae-7af3-87ce-7161" hidden="false">
      <description>Los vehículos con un inhibidor de IED evitarán la detonación de cualquier IED dentro de los 6&quot; del vehículo, ya sea que se activen mediante un detonador o por proximidad.</description>
    </rule>
    <rule name="Sistema Táctico de Guerra Electrónica" id="9262-8512-0fe5-4f17" hidden="false">
      <description>Si un vehículo está equipado con este sistema, el comandante de la fuerza enemiga no podrá hacer solicitudes de escalada y se anularán todos los beneficios para las fuerzas combinadas, la comunicación de observación avanzada y la comunicación de largo alcance en la fuerza enemiga.
Además, la percepción de todas las unidades dentro de la fuerza que contenga este sistema tendrá un bono de +1. Cualquier unidad enemiga oculta que tenga dispositivos de comunicación será detectado automáticamente.</description>
    </rule>
    <rule name="Blindaje de Rejas" id="ff30-9540-6f8d-7214" hidden="false">
      <description>Los vehículos con blindaje de rejas aumentarán su (B) en 1 contra armas con la regla Antiblindaje realizadas en un combate por una unidad de infantería.</description>
    </rule>
    <rule name="Blindaje de Rejillas Superior" id="3ab0-aca6-2a0c-19b9" hidden="false">
      <description>Los vehículos con blindaje de rejillas superior aumentarán su (B) en 1 punto contra drones de detonación remota con la regla Antiblindaje y Guiado.</description>
    </rule>
    <rule name="Estabilizador de Arma" id="d998-499e-0a80-550a" hidden="false">
      <description>Una Acción de Combate tampoco sufrirá una penalización de una Acción de Maniobra que se realice antes del Combate, debido a la estabilización del arma y el ordenador de asistencia balística.</description>
    </rule>
    <rule name="Humo de Fósforo Blanco" id="ef95-5756-d7e6-68d4" hidden="false">
      <description>-Además de las reglas de Humo, genera Letalidad 8+ a la Unidad afectada.
Se aplican las siguientes reglas durante el resto del turno:
- La unidad afectada obtiene un bonificador de +4 a las Pruebas de Percepción. Este bonificador solo está activo mientras la Unidad esté dentro o totalmente oculto por el humo.
- La Unidad afectada no puede realizar acciones de combate.
Una Unidad amiga puede ser objetivo de armas con la regla de humo.</description>
    </rule>
    <rule name="Humo Marcador" id="32b8-b5e0-5f7d-1117" hidden="false">
      <description>- Añade +2 a la tirada de Fuego Preciso
Se aplican las siguientes reglas durante el resto del turno:
- La unidad afectada obtiene un bonificador de +4 a las Pruebas de Percepción. Este bonificador solo está activo mientras la Unidad esté dentro o totalmente oculto por el humo.
- La Unidad afectada no puede realizar acciones de combate.
Una Unidad amiga puede ser objetivo de armas con la regla de humo.</description>
  ...
  <sharedSelectionEntries>
    <selectionEntry name="Blindaje Corporal" id="3362-a69c-9050-dcd4" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="a6d5-0daf-33b3-32c3" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Blindaje Corporal" id="d323-9145-0a4d-e4ec" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
            <characteristic name="Descripción" typeId="8943-2b21-512c-8bb6">El Blindaje Corporal reducirá la Letalidad de un arma en 1, con un mínimo de 10+.</characteristic>
          </characteristics>
        </profile>
      </profiles>
    </selectionEntry>
    <selectionEntry name="Blindaje Corporal Pesado" id="be73-0cec-e2bf-9ff4" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="a8bf-3790-2cc9-ae21" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Blindaje Corporal Pesado" id="3890-d040-ad78-76ce" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Traje Desactivación de Explosivos" id="9462-5c47-4e31-4daf" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="b250-41b6-57f2-e3cf" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Traje Desactivación de Explosivos" id="7f08-7f48-9cd3-8485" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
...
Esto es acumulativo con otros elementos como el blindaje corporal. Si una unidad tiene al menos 1 miniatura por cada 3 con un Escudo Completo, esa unidad se beneficiará de un adicional de +2 en sus Pruebas de Percepción.</characteristic>
    ...
    <selectionEntry name="Exoesqueleto" id="766b-1fc0-1215-9585" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="bc2c-6ac9-7559-5d34" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Exoesqueleto" id="3e17-cd57-60a9-bc5d" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Respirador Uso Corto" id="bdad-1a83-592b-cadf" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="9262-ba3f-fabc-9998" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Respirador Uso Corto" id="5576-76fc-a58d-6e7a" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Respirador Uso Prolongado" id="6b15-3fb8-5832-1b78" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="d4ad-be91-daf2-165f" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Respirador Uso Prolongado" id="44aa-de5e-dd82-36ba" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Traje NRBQ" id="d39c-967c-7035-883e" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="f8d2-69a0-947f-4612" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Traje NRBQ" id="3854-55c0-ae30-43e3" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="IED" id="ab3e-18db-00a9-3f4e" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="5d77-a8e3-fe0d-e40b" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="IED" id="a19b-7913-3a35-2edf" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Detonador de IED" id="cb03-cee4-ea46-cd03" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="c1dc-a619-cfef-8881" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Detonador de IED" id="2bb6-1588-f2e3-9fea" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
...
Si el Dispositivo es un Chaleco Bomba, la Reacción puede realizarse si se pasa una Prueba de Percepción durante un Combate. Detonar inmediatamente el Dispositivo después de que se supere la prueba.</characteristic>
    ...
    <selectionEntry name="Silenciador" id="0286-c9db-88a9-0657" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="a607-d023-d52b-f332" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Silenciador" id="0a58-36e5-adae-d9e4" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
...
Las pruebas de Percepción de las Unidades Objetivo que están siendo disparadas por armas silenciadas se reduce en -1. Además, los disparos realizados desde un Arma Silenciada tienen reglas especiales para la Detección, detalladas en la página 88.</characteristic>
    ...
    <selectionEntry name="Equipamiento CQB" id="2b2a-da7f-e182-fd1f" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="1da6-8dc2-7548-f748" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Equipamiento CQB" id="febe-ec09-3b98-9663" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
...
Durante una Acción de Combate, si la Unidad Objetivo está dentro del rango de CQB, una miniatura o Unidad con un arma de construcción CQB puede volver a tirar un solo resultado fallido para Impactar y Letalidad una vez por Combate.</characteristic>
    ...
    <selectionEntry name="Equipamiento Media Distancia" id="3766-21f9-3596-138f" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="5f90-8e7a-e58c-69a2" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Equipamiento Media Distancia" id="e426-36b6-da3e-bf63" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
...
Durante una Acción de Combate, si la Unidad Objetivo está dentro del rango de combate, una miniatura o Unidad con un arma de construcción de Media Distancia puede volver a tirar un solo resultado fallido para Impactar y Letalidad una vez por Combate.</characteristic>
    ...
    <selectionEntry name="Equipamiento Larga Distancia" id="a71d-b074-72d8-2f72" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="ec2a-05e8-3fdb-448e" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Equipamiento Larga Distancia" id="581a-0ccd-7d3a-58b3" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
...
Durante una Acción de Combate, si la Unidad Objetivo está dentro del rango Extremo, una miniatura o Unidad con un arma de construcción de larga distancia puede volver a tirar un solo resultado fallido para Fuego Preciso y Letalidad una vez por Combate.</characteristic>
    ...
    <selectionEntry name="Combatiente Nocturno" id="ffe0-6569-6966-b962" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="3ed8-7440-aca0-10c9" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Combatiente Nocturno" id="46cf-7445-432b-71ce" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="NVG Mk1" id="b46d-7a8f-ae5e-1424" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="5195-b5d8-9311-af96" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="NVG Mk1" id="8e3a-81e1-412b-5592" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="NVG Mk2" id="a704-ebdc-5ce1-b20e" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="f254-7350-e805-6f0a" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="NVG Mk2" id="58bc-acb1-1834-5c75" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="NVG Mk3" id="3551-7989-0900-ea72" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="0d5c-eaac-44ae-9bfb" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="NVG Mk3" id="f6f9-fef8-dcc4-78cf" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Gafas Térmicas Híbridas" id="2c3e-74f7-3abd-82e2" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="79d4-7d90-9108-9608" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Gafas Térmicas Híbridas" id="cc64-cc6d-ee69-d2aa" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Ópticas Térmicas" id="f46c-8417-4a9b-16d1" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="9a8e-8644-b69b-c4d4" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Ópticas Térmicas" id="97fe-4869-425c-d2bb" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Realidad Aumentada" id="cb29-f15f-d349-a197" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="aa24-0d14-d389-0ba3" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Realidad Aumentada" id="da7d-bea4-c635-9211" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Traje de Operador Hiper Consciente" id="077b-f5b2-ab0e-4be6" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="89df-e7cc-d653-106d" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Traje de Operador Hiper Consciente" id="6310-eb21-2586-2033" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
...
Detectar unidades encubiertas o trampas/IED se beneficiará de +3 de Percepción.</characteristic>
    ...
    <selectionEntry name="Traje IA" id="0a64-aa97-f9b9-bb27" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="36b1-98d9-5cb1-5da1" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Traje IA" id="7f3c-44d5-b1b2-0fa7" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Visor de Observador" id="5217-ec53-1996-5f8d" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="cb09-475f-fcc7-b261" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Visor de Observador" id="38c4-78c3-2279-3c01" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Telémetro" id="305d-dcef-e102-0ddd" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="068b-c567-36da-c758" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Telémetro" id="9dcf-cf9b-4457-9251" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Incendiaria" id="4615-6b07-2abc-355d" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="1304-9e2f-92b6-f2e8" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Incendiaria" id="7952-9465-7eb3-1131" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
...
Los vehículos que sufren un impacto superficial de un arma con munición incendiaria, además de cualquier otro efecto, siempre harán un impacto en la tripulación. Todos los impactos superficiales y penetrantes también conferirán un +1 adicional de Estrés.</characteristic>
    ...
    <selectionEntry name="Punta Hueca" id="6be6-3ac7-f645-e2e0" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="f97a-f492-01b9-e7f7" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Punta Hueca" id="5854-2e49-774d-3d4a" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
...
Los impactos de un arma con munición de punta hueca se beneficiarán con +1 de Letalidad en el rango de CQC y de Combate si el objetivo no lleva Armadura Corporal.</characteristic>
    ...
    <selectionEntry name="Bala de Escopeta" id="7e63-a946-031d-e932" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="6b38-b807-8580-f4a6" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Bala de Escopeta" id="c8b6-6eba-bef4-9722" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Flechette para Escopeta" id="3641-ea0a-a1cd-86de" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="5736-3ded-952e-d693" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <infoLinks>
        <infoLink name="Penetración de Blindaje" id="e32d-40bf-489c-3001" hidden="false" targetId="d4ed-a106-4ec9-1c42" type="rule"/>
      </infoLinks>
      <profiles>
        <profile name="Flechette para Escopeta" id="f9d0-9de7-2d46-9aed" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Detector de Disparos" id="9435-6b0c-e914-e436" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="2b17-f656-f5ca-405c" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Detector de Disparos" id="8ffe-b90d-eff6-db51" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Inhibidor de Artefactos Explosivos" id="cf85-f181-9604-17e7" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="6122-73ba-769a-4f50" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Inhibidor de Artefactos Explosivos" id="57b7-f964-69fb-4519" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Comunicaciones de Larga Distancia" id="a1c3-df18-e636-830a" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="db68-04f4-d67b-c9ee" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Comunicaciones de Larga Distancia" id="ce69-2d55-03f5-cd1e" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Comunicaciones de Fuerzas Combinadas" id="a722-b5a2-991d-3cb8" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="1532-5a3a-a009-caf1" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Comunicaciones de Fuerzas Combinadas" id="dc37-e7ca-a53a-0964" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Comunicaciones de Observación Avanzada" id="4183-ba1e-eb1c-09f9" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="66ad-7c0a-5b38-2c65" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Comunicaciones de Observación Avanzada" id="f112-f1c4-c62b-687a" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Designador Láser" id="a5b6-b296-ca76-719f" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="28a3-5ad2-a4e8-20ed" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Designador Láser" id="2972-770e-97d7-ec1e" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Traje Ghillie" id="0032-9893-78ba-2be9" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="d223-facf-a2db-f2ba" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Traje Ghillie" id="4b6e-5add-cb91-c806" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Camuflaje Térmico" id="d0ba-30a0-35f1-b301" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="b8d0-a5c3-090b-e7e7" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Camuflaje Térmico" id="386d-e7e0-068a-d1c3" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Herramientas de Brecha  Pesadas" id="55ad-80e2-999c-7df2" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="0cc1-848c-70b5-81d0" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Herramientas Pesadas" id="c67d-c286-92ab-ee97" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Explosivos de Brecha" id="103c-5948-71d2-6a2e" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="efe0-7469-3077-873f" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Explosivos de Brecha" id="e9ad-ffd0-6168-e0b1" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Herramientas de Brecha Electrónicas" id="b275-15bf-1a6a-5bb6" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="5485-109f-07db-76b6" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Herramientas Electrónicas" id="f9bd-1b3c-b6e9-da50" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Ganzúas" id="34d8-e5b2-6ca0-1469" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="850c-54a8-78ee-f377" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Ganzúas" id="3ac5-9833-5e6a-f329" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Arma de Defensa Personal" id="a7c1-9441-8533-f70e" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="a6bc-a9d0-7f76-2f76" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Arma de Defensa Personal" id="0c45-7cc2-55c2-4372" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Arma de Especialista" id="e0a6-7fcd-04e5-db15" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="a5b0-ea12-7464-b1d3" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Arma de Especialista" id="3ad8-00f5-9b57-8e7d" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="RWS Ligero" id="c462-9aba-6922-c7ee" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="dcb6-6faa-8a6b-4ec3" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Sistema de Armas Remotas (RWS)" id="dc6d-8ef6-cfc7-97b1" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
        ...
        <profile name="RWS Ligero" id="ec2f-7cd3-fbab-e80d" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="RWS Medio" id="0a79-7e49-f567-0825" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="d710-a7b6-d032-80b6" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Sistema de Armas Remotas (RWS)" id="378b-3941-a4f6-09c0" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
            <characteristic name="Descripción" typeId="8943-2b21-512c-8bb6">Los SWR no tendrán ningún modificador para acertar cuando se aplique momentum adicional a un combate utilizando el arma. El arma también obtendrá los beneficios de las NVG Híbridas Térmicas MK3 (página 58) para representar sus ópticas avanzadas y sistemas de puntería. Una Acción de Combate tampoco sufrirá una penalización por realizar un movimiento antes del combate, debido a la estabilización del arma y el ordenador de asistencia balística.</characteristic>
          </characteristics>
        </profile>
        <profile name="RWS Medio" id="e2f2-370b-ba5f-792d" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="RWS Pesado" id="4454-92c6-c2c9-f65b" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="a438-7373-d96b-d17d" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Sistema de Armas Remotas (RWS)" id="7ca6-3b95-02de-c6f1" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
            <characteristic name="Descripción" typeId="8943-2b21-512c-8bb6">Los SWR no tendrán ningún modificador para acertar cuando se aplique momentum adicional a un combate utilizando el arma. El arma también obtendrá los beneficios de las NVG Híbridas Térmicas MK3 (página 58) para representar sus ópticas avanzadas y sistemas de puntería. Una Acción de Combate tampoco sufrirá una penalización por realizar un movimiento antes del combate, debido a la estabilización del arma y el ordenador de asistencia balística.</characteristic>
          </characteristics>
        </profile>
        <profile name="RWS Pesado" id="704c-96e5-ac8e-ef63" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Estabilizador del Arma" id="6f69-ce24-e051-4d91" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="3ef4-6ecc-1407-b6e5" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Estabilizador del Arma" id="5cef-9937-798d-80c4" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Arma en Afuste Exterior" id="4158-de2b-7fcf-ddd4" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="446a-9614-6486-b03a" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Arma en Afuste Exterior" id="1a6d-b08a-f28a-3dfe" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Blindaje Reactivo" id="7952-3058-49cf-6595" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="4ccd-b814-09ad-4e0d" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Blindaje Reactivo" id="c312-033b-cbae-b2b6" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
...
Si se utiliza una de estas armas en un combate con un Vehículo con ERA, las unidades de infantería a de 3” del Vehículo sufrirán un impacto de AoE 3, con una Letalidad de 6.</characteristic>
    ...
    <selectionEntry name="Blindaje Reactivo Avanzado" id="e90a-1dd4-7c4a-f639" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="bcff-9bce-846d-e244" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Blindaje Reactivo Avanzado" id="8c66-5c85-1b13-cc57" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
...
Si se utiliza una de estas armas en un combate con un Vehículo con ERA, las unidades de infantería a de 3” del Vehículo sufrirán un impacto de AoE 3, con una Letalidad de 6.</characteristic>
    ...
    <selectionEntry name="APS 1ª Generación" id="20a2-4eca-90dc-d100" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="5375-f1fc-3fc8-5a0a" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="APS 1ª Generación" id="c38f-37f3-0a2f-6bbf" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="APS Nueva Generación" id="15b9-9d30-801d-da1e" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="cd98-1cb4-d928-a4d8" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="APS Nueva Generación" id="7bf6-dca0-5157-aaef" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
            <characteristic name="Descripción" typeId="8943-2b21-512c-8bb6">Si un vehículo con un APS es la Unidad Objetivo en un Combate con un arma con la Regla de Penetración de Blindaje, Antiblindaje o Antitanque y es impactado, al realizar una Prueba de Percepción, el valor de Percepción del vehículo se incrementa a 6. Las Armas Guiadas tampoco obtienen beneficios de la Regla Guiado.
El Valor de Percepción del Vehículo al realizar pruebas de Percepción se incrementa a 5. Los APS avanzados también utilizan estas reglas cuando son el Objetivo de un Arma con el Penetrador Cinético. Las reglas especiales de Ataque desde Arriba también se ignoran cuando se usan contra un Vehículo con APS avanzado.</characteristic>
    ...
    <selectionEntry name="Descargadores de Humo" id="630b-6e65-f43c-b66e" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="5a3e-85cc-61f5-0621" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Descargadores de Humo" id="ae48-008f-a66a-7eec" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Protección contra minas" id="ea51-29a3-b419-0364" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="837b-25f0-895b-05c8" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Protección contra minas" id="3654-aff7-19b4-93bf" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Protección reforzada para tripulación" id="8390-a2d5-a9d3-f2cc" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="7b2f-d7e1-e9d0-9410" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Protección reforzada para tripulación" id="c97f-c0eb-56e1-0283" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Inhibidor de Explosivos" id="3cb7-47de-5614-390d" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="1891-9bd0-2408-8634" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Inhibidor de Explosivos" id="262d-7ddd-4733-9244" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Sistema Táctico de Guerra Electrónica" id="bce4-30ff-7c9f-ef7c" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="ef05-276d-6c5b-6168" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Sistema Táctico de Guerra Electrónica" id="f29f-e718-c2c9-7db6" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
...
Además, la percepción de todas las unidades dentro de la fuerza que contenga este sistema tendrá un bono de +1. Cualquier unidad enemiga oculta que tenga dispositivos de comunicación será detectado automáticamente.</characteristic>
    ...
    <selectionEntry name="Blindaje de Rejas" id="1108-67c0-0f05-bfb2" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="7245-7fe5-db5d-c468" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Blindaje de Rejas" id="b9ef-0080-2ce5-0bae" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Blindaje de Rejillas Superior" id="b1e0-e07e-d9a0-679d" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="129d-4ff7-6da7-a988" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Blindaje de Rejillas Superior" id="68a4-21c6-7f2c-ed02" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Perro No Entrenado" id="e6b3-a917-3f81-e6de" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="1cf4-7f3b-2c34-c606" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <infoLinks>
        <infoLink name="Perro No Entrenado" id="241f-7995-269a-8c60" hidden="false" targetId="624d-8df3-4389-1edf" type="profile"/>
      </infoLinks>
    </selectionEntry>
    <selectionEntry name="Perro Entrenado" id="7794-7527-c19d-448c" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="e55b-5e6d-ae5b-1536" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <infoLinks>
        <infoLink name="Perro Entrenado" id="0e49-a81b-74c5-f06d" hidden="false" targetId="9046-535d-f3ea-c264" type="profile"/>
      </infoLinks>
    </selectionEntry>
    <selectionEntry name="Blindaje Corporal Encubierto" id="4b8e-1de9-d9b8-80aa" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="349e-9ae4-594b-be0f" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Blindaje Corporal Encubierto" id="6e83-e1dd-5d0e-37a4" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
    ...
    <selectionEntry name="Comunicaciones Reforzadas" id="1fdb-9d95-7b1c-6f8f" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="9753-d24c-a157-1b15" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Comunicaciones Reforzadas" id="4a85-9776-82a7-d0a6" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
            <characteristic name="Descripción" typeId="8943-2b21-512c-8bb6">Las Comunicaciones Reforzadas no se ven afectadas por Dispositivos de Guerra Electrónica o Hacking.</characteristic>
          </characteristics>
        </profile>
      </profiles>
    </selectionEntry>
    <selectionEntry name="Ordenes avanzadas de K9" id="c63e-6354-45f9-49ef" hidden="false" import="true" type="upgrade">
      <constraints>
        <constraint id="013b-07d0-0e4f-e9c1" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
      </constraints>
      <profiles>
        <profile name="Ordenes avanzadas de K9" id="baac-9559-b9b3-9eef" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
          <characteristics>
            <characteristic name="Descripción" typeId="8943-2b21-512c-8bb6">Un perro con este equipamiento puede maniobrar a cualquier distancia de su Guía Canino</characteristic>
          </characteristics>
        </profile>
      </profiles>
    </selectionEntry>
    <selectionEntry name="Civil" id="4802-c471-e86a-b93e" hidden="false" import="true" type="upgrade">
      <infoLinks>
        <infoLink name="Civil" id="382f-5019-48a1-5d8e" hidden="false" targetId="d2df-5d35-cf20-9324" type="profile"/>
      </infoLinks>
    </selectionEntry>
    <selectionEntry name="Criminal" id="851f-6dc6-6767-cf60" hidden="false" import="true" type="upgrade">
      <infoLinks>
        <infoLink name="Criminal" id="d4f4-ade4-9c5e-1b5f" hidden="false" targetId="3c83-9cde-8e46-659d" type="profile"/>
      </infoLinks>
    </selectionEntry>
    <selectionEntry name="Milicia" id="5f8d-85d6-f141-3076" hidden="false" import="true" type="upgrade">
      <infoLinks>
        <infoLink name="Milicia" id="de7f-be5a-cbe3-c4f4" hidden="false" targetId="309c-9800-d8c1-1acd" type="profile"/>
      </infoLinks>
    </selectionEntry>
    <selectionEntry name="Recluta" id="5769-dc19-dd7a-e770" hidden="false" import="true" type="upgrade">
      <infoLinks>
        <infoLink name="Recluta" id="f404-57b8-0331-8943" hidden="false" targetId="aac1-39ef-dfed-abde" type="profile"/>
      </infoLinks>
    </selectionEntry>
    <selectionEntry name="Militares" id="0327-fbf0-8a83-80c5" hidden="false" import="true" type="upgrade">
      <infoLinks>
        <infoLink name="Militares" id="89a1-b734-5c4c-ed25" hidden="false" targetId="9139-4807-47ea-d8b2" type="profile"/>
      </infoLinks>
    </selectionEntry>
  ...
  <sharedSelectionEntryGroups>
    <selectionEntryGroup name="Configuración de Especialista" id="629a-55fc-c94b-1710" hidden="false">
      <entryLinks>
        <entryLink name="Equipamiento Larga Distancia" id="7b78-9252-c541-cc39" hidden="false" import="true" sortIndex="3" targetId="a71d-b074-72d8-2f72" type="selectionEntry"/>
        <entryLink name="Equipamiento Media Distancia" id="0a3c-5f9d-078b-bb0a" hidden="false" import="true" sortIndex="2" targetId="3766-21f9-3596-138f" type="selectionEntry"/>
        <entryLink name="Equipamiento CQB" id="9c72-e02c-7b5a-11b8" hidden="false" import="true" sortIndex="1" targetId="2b2a-da7f-e182-fd1f" type="selectionEntry"/>
        <entryLink name="Combatiente Nocturno" id="4439-cf23-035c-a669" hidden="false" import="true" sortIndex="4" targetId="ffe0-6569-6966-b962" type="selectionEntry"/>
      </entryLinks>
    </selectionEntryGroup>
    <selectionEntryGroup name="Municiones Especiales" id="8417-f073-010b-93eb" hidden="false">
      <entryLinks>
        <entryLink name="Incendiaria" id="a5ae-9cc9-dd7c-cc42" hidden="false" import="true" sortIndex="3" targetId="4615-6b07-2abc-355d" type="selectionEntry"/>
        <entryLink name="Punta Hueca" id="1507-4568-515c-fbbd" hidden="false" import="true" sortIndex="4" targetId="6be6-3ac7-f645-e2e0" type="selectionEntry"/>
        <entryLink name="Bala de Escopeta" id="1a21-1ac9-273c-9531" hidden="false" import="true" sortIndex="1" targetId="7e63-a946-031d-e932" type="selectionEntry"/>
        <entryLink name="Flechette para Escopeta" id="3a9d-567f-bc5a-3a60" hidden="false" import="true" sortIndex="2" targetId="3641-ea0a-a1cd-86de" type="selectionEntry"/>
      </entryLinks>
    </selectionEntryGroup>
    <selectionEntryGroup name="Nárcoticos" id="c60d-fefb-28f4-0122" collapsible="true" hidden="false">
      <infoLinks>
        <infoLink name="Cocktail de Sustancias" id="b102-b553-71f6-6082" hidden="false" targetId="46bd-3cb8-e65b-bcb4" type="rule"/>
      </infoLinks>
      <selectionEntries>
        <selectionEntry name="Anestésicos" id="9bb5-e47e-56cc-1b60" hidden="false" import="true" type="upgrade">
          <constraints>
            <constraint id="0889-32f0-35d9-008f" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
          </constraints>
          <costs>
            <cost name="Recursos" typeId="e097-af1e-bf07-f031" value="5"/>
          </costs>
          <profiles>
            <profile name="Anestésicos" id="d1a0-09c7-4983-46ec" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
              <characteristics>
...
Si una miniatura es impactada en un Combate, pero no muere, el combatiente no se convertirá en una baja, ya que no notará sus heridas.</characteristic>
        ...
        <selectionEntry name="Estimulantes" id="0329-cdbf-c256-82ec" hidden="false" import="true" type="upgrade">
          <constraints>
            <constraint id="36b2-7ca0-2962-3caa" field="selections" includeChildSelections="false" scope="parent" shared="true" type="max" value="1"/>
          </constraints>
          <costs>
            <cost name="Recursos" typeId="e097-af1e-bf07-f031" value="5"/>
          </costs>
          <profiles>
            <profile name="Estimulantes" id="8a3a-621b-68cf-4fb4" hidden="false" typeId="6838-76bd-df50-3dbe" typeName="Equipamiento">
              <characteristics>
